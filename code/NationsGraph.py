...
def main():
    ...
    edge_dict = extrapolate_country_edges(
        nx.readwrite.read_gexf('../data/sister_cities_data/reduced_sister_cities.gexf'))
    G = build_nations_graph(edge_dict)
    nx.write_gexf(G, '../data/sister_cities_data/reduced_nations_sister_cities.gexf')

    # Builds nations graph for airline routes
    edge_dict = extrapolate_country_edges(
        nx.readwrite.read_gexf('../data/airline_routes_data/reduced_routes.gexf'))
    G = build_nations_graph(edge_dict)
    nx.write_gexf(G, '../data/airline_routes_data/reduced_nations_routes.gexf')
