...
In addition to the previously described graphs, we decided to integrate an alternative graph structure in our analysis. For both the twinning-relationships' graph and the airline routes' graph we built a corresponding one as follows:
