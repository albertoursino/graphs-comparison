...
- *Distances between nodes*: analyze some graphs paths (e.g. the shortest path from two cities in both graphs) and try to find similarities. 
- [*in progress...*]
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExNTAwMTMwNzksNTM2Njc5NzQ5LC04MD
