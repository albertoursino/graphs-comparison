...
We have to say that these points can change during the project development: some of them can be crucial in order to obtain interesenting results, some of them, instead, can be useless and so to leave out. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAzNzU2Mzg1LDEyNTU5MjA2NzIsLTIwOD
